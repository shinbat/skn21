...
def create(request):
    ...
    if request.method == "GET":
        ...
        if form.is_valid(): # 요청파라미터에 문제가 없는 경우
            ## 2. DB에 저장
            # ModelForm은 save()를 제공. 요청파라미터 값들을 DB에 insert/update해준다.
            ...
            return render(
                request, 
                "account/create.html",
                {"form":form} # 문제가있는 Form을 context value로 전달.
            )
